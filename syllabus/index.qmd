...
All students are required to complete the [prerequisite assessment quiz](https://sdsu.instructure.com/courses/116162/quizzes/224625) before Wednesday 8-23 3:00pm.
...
| Abbrevation | Source                                                                                      |
|-------------|---------------------------------------------------------------------------------------------|
| GDA         | Tenkanen, H., V. Heikinheimo, D. Whipp (2023) Python for Geographic Data Analysis. CRC Press.|
...
python introduction 01
python variables, expressions, statments 02
python functions 04

| Week | Dates  | Topic                         | Reading | Due        |
|------+--------+-------------------------------+---------+------------|
| 1    | Aug-21 | Course Introduction           |         |            |
|      | Aug-23 | Jupyter Hub                   | GDA1    |            |
| 2    | Aug-28 | Python: Programming Concepts  | GDA2    | Quiz 1     |
|      | Aug-30 | Python: Data Analysis         | GDA3    |            |
| 3    | Sep-04 | *Labor Day Holiday*           |         |            |
|      | Sep-06 | Python: Visualization         | GDA4    |            |
| 4    | Sep-11 | Python: Geographic Data       | GDA5    | Quiz 2     |
|      | Sep-13 | Geopandas and PySAL           | GDA6    | Exercise 1 |
| 5    | Sep-18 | Spatial Data Overview         |         | Quiz 3     |
